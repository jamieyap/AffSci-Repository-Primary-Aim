# Affective Science Micro-Randomized Trial

## Description

The material in this repository contains code and documentation developed for the Primary Aims manuscript of the Affective Science Micro-Randomized Trial (MRT).
