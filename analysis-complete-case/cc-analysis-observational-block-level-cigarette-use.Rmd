---
title: "Affective Science MRT: Block-Level Analysis - Association between Engagement and Cigarette Use"
...
plot(analytic_population_concurrent_count_by_dp$decision_point, analytic_population_concurrent_count_by_dp$count, type = "o", ylim = c(0,130), xaxt = "n", xlab = "Decision Point", ylab = "Number of participants", lwd = 4, col = "blue")
...
plot(analytic_population_lagged_count_by_dp$decision_point, analytic_population_lagged_count_by_dp$count, type = "o", ylim = c(0,130), xaxt = "n", xlab = "Decision Point", ylab = "Number of participants", lwd = 4, col = "blue")
axis(1, at = seq(6,54,6))
